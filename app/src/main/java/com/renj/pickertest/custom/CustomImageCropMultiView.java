package com.renj.pickertest.custom;
 ...
 * ======================================================================
 */
public class CustomImageCropMultiView extends ImagePickerCropLayout {
    ...
    public CustomImageCropMultiView(@NonNull Context context) {
        super(context);
    }

    @Override
    protected int getLayoutId() {
        return R.layout.custom_crop_multi_layout;
    }

    @Override
    protected void initView(View multiCropView) {
        tvCancel = multiCropView.findViewById(com.renj.imagepicker.R.id.tv_cancel_more);
        tvCrop = multiCropView.findViewById(com.renj.imagepicker.R.id.tv_crop_more);
        vpCropMore = multiCropView.findViewById(com.renj.imagepicker.R.id.vp_crop_more);
